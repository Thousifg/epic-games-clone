    ...
    <div className={styles.sicontainer}>
      <div id={styles.siicons}>
        <div id={styles.sisocial}>
          <div>
            <AiFillFacebook id={styles.sifbicon}></AiFillFacebook>
          </div>
          <div>
            <AiOutlineTwitter id={styles.sitwicon}></AiOutlineTwitter>
          </div>
          <div>
            <AiFillYoutube id={styles.siyticon}></AiFillYoutube>
          </div>
        </div>
        <div id={styles.siudiv}>
          <MdOutlineExpandLess id={styles.siupicon}></MdOutlineExpandLess>
        </div>
      </div>
      <div id={styles.siresources}>
        <div className={styles.sihead}>
          <p>Resources</p>
        </div>
