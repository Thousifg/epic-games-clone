...
export const IndividualGame = () => {
  ...
  const getData = () => {
    axios
      .get(`https://apple-cupcake-41384.herokuapp.com/games/${id}`)
      .then((res) => {
  ...
  const addToCart = (id) => {
    if (currentUser == null) {
      ...
      axios
        .post(
          `https://apple-cupcake-41384.herokuapp.com/cart/additem/${currentUser._id}`,
          cart_data
        )
        .then((res) => {
          console.log(res);
        ...
        <div className="rmainDiv">
          <div className="rleftmainDiv">
            ...
            <div className="ropenworld">
              ...
              <p className="rdesdes">
                Includes {game.title} story mode and online
                <br />
                <br />
                In {game.title} video game, an open world is a game mechanic of
                using a virtual world that the player can explore and approach
                objectives freely, as opposed to a world with more linear and
                structured gameplay. While games have used open-world designs
                since the 1980s, the implementation in Grand Theft Auto III
                (2001) set a standard for the concept which has been used since.{" "}
                <br />
                <br />
                Games with open or free-roaming worlds typically lack level
                structures like walls and locked doors, or the invisible walls
                in more open areas that prevent the player from venturing beyond
                them; only at the bounds of an open-world game will players be
                limited by geographic features like vast oceans or impassable
                mountains. Players typically do not encounter loading screens
                common in linear level designs when moving about the game world,
                with the open-world game using strategic storage and memory
                techniques to load the game world in a dynamic and seamless
                manner. Open-world games still enforce many restrictions in the
                game environment, either because of absolute technical
                limitations or in-game limitations imposed by a game's
                linearity.
              </p>
            </div>
            ...
            <div className="rspecificationDiv">
              ...
              <div className="rspecLang">
                <div className="rspeclanguage">
                  ...
                  <p>
                    Voice: English Text: English Simplified Chinese Traditional
                    Chinese Portuguese ( Brazilian ) French German Italian
                    Japanese Korean Polish Russian Portuguese Spanish (Spain )
                    Spanish (LATAM)
                  </p>
                </div>
              </div>
          ...
          <div className="rrightmainDiv">
            ...
            <button id="raddwishlist">
              <RiAddCircleLine className="rrwishcircle" />
              ADD TO WISHLIST
            </button>
            <div>
